...
sparrow --master yarn --num-executors 4  --executor-cores 4 --executor-memory 8g --driver-memory 8g --driver-cores 4 -e "
insert into table quality_carbon_new.es_idms_defect SELECT t3.OWNER AS OWNER
         ,vr.Rname AS Rname
         ,vr.Vname AS Vname
         ,bd.NAME AS baseline
