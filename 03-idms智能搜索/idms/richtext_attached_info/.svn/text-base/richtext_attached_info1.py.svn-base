...
se.sql("create table quality_outbound_hive.tmp_richtext_attached_info as \
    select a.* from quality_outbound_hive.richtext_attached_info a left join \
    quality_landing_hive.richtext_incr b on a.richtextid = b.richtextid \
    where b.richtextid is null")
