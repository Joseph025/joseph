...
drop table if exists quality_carbon.es_idms_test;

CREATE TABLE IF NOT EXISTS quality_carbon.es_idms_test
USING org.elasticsearch.spark.sql
OPTIONS
( 
resource 'idms_test/content',
nodes 'node2.it.h3c.com',
pushdown 'true',
port '9205',
...
insert into table quality_carbon.es_idms_test SELECT t3.OWNER AS OWNER
         ,vr.Rname AS Rname
         ,vr.Vname AS Vname 
