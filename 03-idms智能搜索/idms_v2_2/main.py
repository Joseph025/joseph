...
def readDataFromHive(spark,input_table):
    sql="select defectNo as name,summary as describe,content as detail from "+input_table+" limit 200000"
...
if __name__ == '__main__':
    ...
    contentList=extraction.put(spark,data)
    ...
    spark.createDataFrame(list_kdd,schema).write.saveAsTable("quality_carbon_new.es_idms_defect_v4_output", mode="overwrite")
    spark.stop()
